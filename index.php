...
<p class="hero-slogan" style="margin: 15px 20px; text-align: center; color: white;">Si está en el Putumayo, está aquí. Conectamos negocios de todos los tamaños con clientes reales.</p>

<form action="buscar.php" method="GET" class="search-box" style="display: flex; flex-direction: column; gap: 10px; width: 90%; max-width: 500px; margin: 0 auto; background: white; padding: 15px; border-radius: 12px; box-shadow: 0 4px 10px rgba(0,0,0,0.2);">
    
    <input type="text" name="q" placeholder="¿Qué buscas? (Ej: Pizza, Ropa, Hotel)..." required style="padding: 14px; font-size: 16px; border: 1px solid #ddd; border-radius: 8px; width: 100%; box-sizing: border-box; -webkit-appearance: none; appearance: none; height: 50px;">
    
    <select name="ciudad" style="padding: 14px; font-size: 16px; border: 1px solid #ddd; border-radius: 8px; width: 100%; box-sizing: border-box; background-color: white; -webkit-appearance: none; appearance: none; height: 50px;">
    ...
    <button type="submit" style="background-color: #ffc107; color: black; font-weight: bold; padding: 14px; font-size: 16px; border: none; border-radius: 8px; width: 100%; cursor: pointer; height: 50px; text-transform: uppercase;">🔍 Buscar</button>
</form>
    </div>
</header>
